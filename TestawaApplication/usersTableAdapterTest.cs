...
namespace TestawaApplication
{
    ...
    /// <summary>
    ///This is a test class for usersTableAdapterTest and is intended
    ///to contain all usersTableAdapterTest Unit Tests
    ///</summary>
    [TestClass()]
    public class usersTableAdapterTest
    {
        ...
        {
            usersTableAdapter target = new usersTableAdapter(); // TODO: Initialize to an appropriate value
            AutoWebAgentDBDataSet.usersDataTable dataTable = null; // TODO: Initialize to an appropriate value
            int expected = 0; // TODO: Initialize to an appropriate value
            int actual;
        ...
        /// <summary>
        ///A test for usersTableAdapter Constructor
        ///</summary>
        [TestMethod()]
