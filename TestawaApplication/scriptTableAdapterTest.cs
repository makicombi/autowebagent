...
namespace TestawaApplication
{
    ...
    /// <summary>
    ///This is a test class for scriptTableAdapterTest and is intended
    ///to contain all scriptTableAdapterTest Unit Tests
    ///</summary>
    [TestClass()]
    public class scriptTableAdapterTest
    {
        ...
        {
            scriptTableAdapter_Accessor target = new scriptTableAdapter_Accessor(); // TODO: Initialize to an appropriate value
            SqlCeCommand[] actual;
        ...
        {
            scriptTableAdapter target = new scriptTableAdapter(); // TODO: Initialize to an appropriate value
            AutoWebAgentDBDataSet.scriptDataTable dataTable = null; // TODO: Initialize to an appropriate value
            int expected = 0; // TODO: Initialize to an appropriate value
            int actual;
        ...
        public void UpdateTest()
        {
            ...
            Nullable<DateTime> p3 = new Nullable<DateTime>(); // TODO: Initialize to an appropriate value
        ...
        /// <summary>
        ///A test for scriptTableAdapter Constructor
        ///</summary>
        [TestMethod()]
        public void scriptTableAdapterConstructorTest()
        {
            scriptTableAdapter target = new scriptTableAdapter();
