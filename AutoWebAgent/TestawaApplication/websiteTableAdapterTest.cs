...
namespace TestawaApplication
{
    ...
    /// <summary>
    ///This is a test class for websiteTableAdapterTest and is intended
    ///to contain all websiteTableAdapterTest Unit Tests
    ///</summary>
    [TestClass()]
    public class websiteTableAdapterTest
    {
        ...
        {
            websiteTableAdapter_Accessor target = new websiteTableAdapter_Accessor(); // TODO: Initialize to an appropriate value
            SqlCeCommand[] actual;
        ...
        {
            websiteTableAdapter target = new websiteTableAdapter(); // TODO: Initialize to an appropriate value
            AutoWebAgentDBDataSet.websiteDataTable dataTable = null; // TODO: Initialize to an appropriate value
            int expected = 0; // TODO: Initialize to an appropriate value
            int actual;
        ...
        public void UpdateTest()
        {
            ...
            int p3 = 0; // TODO: Initialize to an appropriate value
            int expected = 0; // TODO: Initialize to an appropriate value
            int actual;
            actual = target.Update(p1, p2, p3);
            Assert.AreEqual(expected, actual);
            Assert.Inconclusive("Verify the correctness of this test method.");
        }
        ...
        /// <summary>
        ///A test for websiteTableAdapter Constructor
        ///</summary>
        [TestMethod()]
