...
namespace TestawaApplication
{
    ...
    /// <summary>
    ///This is a test class for elementTableAdapterTest and is intended
    ///to contain all elementTableAdapterTest Unit Tests
    ///</summary>
    [TestClass()]
    public class elementTableAdapterTest
    {
        ...
        {
            elementTableAdapter_Accessor target = new elementTableAdapter_Accessor(); // TODO: Initialize to an appropriate value
            SqlCeCommand[] actual;
        ...
        {
            elementTableAdapter target = new elementTableAdapter(); // TODO: Initialize to an appropriate value
            AutoWebAgentDBDataSet.elementDataTable dataTable = null; // TODO: Initialize to an appropriate value
            int expected = 0; // TODO: Initialize to an appropriate value
            int actual;
        ...
        /// <summary>
        ///A test for elementTableAdapter Constructor
        ///</summary>
        [TestMethod()]
